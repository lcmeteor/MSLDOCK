...
/*----------------------------------------------------------------------------*/
	...
	if (argv[1][0] != '-') {
        ...
        case 'c':
            ...
            fprintf(stderr, "\n%s: command mode is not supported in this version of msdock\n", programname );
            break;
        case 'l':
	    if(argc<=2) {
		...
		return(-1);
            ...
            if ( strindex( dock_param_fn, ".dpf") != (int) strlen(dock_param_fn) - 4){
                fprintf(stderr, "\n MSDOCK needs the extension of the docking parameter file to be \".dpf\"");
                fprintf(stderr, "\n%s: Unsuccessful Completion.\n\n", programname);
                return(-1);
            }
        ...
        case 't':
            ...
            break;
        case 'v':
	    fprintf(stdout, "MSDOCK version 0.4\n");
            fprintf(stdout, "\n");
            ...
            fprintf(stdout, "For more details, please see MSDOCK_README and MSDOCK_RELEASENOTES\n");
            fprintf(stdout, "\n");
