#! /usr/bin/env python
#
# $Id: test_MSautodock4.py,v 1.74 2014/07/16 23:27:27 mp Exp $
#
...
autodock_executable = "../MSautodock4" # where the AutoDock executable resides
...
def usage():
    ...
    print """Usage:  python test_MSautodock4.py [-d <string>] [-e <string>] [-o <string>]
...
where:
    ...
    -e, --executable
        ...
        this flag is optional; default is '../MSautodock4'
...
class AutoDock_base_test( unittest.TestCase ):
    ...
    computed = False
    def setUp( self ):
        """Set up for MSautodock4 tests. Locate the autodock binary now during setUp."""
...
class AutoDock4_1pgp_no_extension( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if .dpf extension is missing
...
class AutoDock4_1pgp_wrong_extension( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if extension is not '.dpf'
    keywords are specified."""
    dpf_stem = "1pgp.fpd"
...
class AutoDock4_1pgp_two_extensions( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if dpf name includes two .dpf
    keywords are specified."""
    dpf_stem = "1pgp.dpf"
...
class AutoDock4_1pgp_ligand_types_map_mismatch( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if number of maps do not equal number
    of ligand types"""
    dpf_stem = "1pgp_ligand_types_map_mismatch"
    expected_outcome = False # True means Successful Completion!
#______________________________________________________________________________
class AutoDock4_1pgp_map_truncated( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if map data is incomplete"""
    dpf_stem = "1pgp_map_truncated"
    expected_outcome = False # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_illegal_keyword_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if it finds an illegal keyword 
    in dpf """
...
class AutoDock4_1pgp_no_elecmap_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if no "elecmap" keyword is specified."""
    dpf_stem = "1pgp_no_elecmap"
    expected_outcome = False # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_no_desolvmap_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if no "desolvmap" keyword is specified."""
    dpf_stem = "1pgp_no_desolvmap"
    expected_outcome = False # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_no_elec_desolv_maps_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if no elecmap and no desolvmap 
    keywords are specified."""
...
class AutoDock4_1pgp_too_many_torsions( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if too many torsions 
...
class AutoDock4_1pgp_just_right_number_torsions( AutoDock_simple_test ):
    """Test that MSautodock4 completes with current limit of number of  torsions 
    are specified. (current limit is 32)"""
...
class AutoDock4_1pgp_too_many_ligand_types_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if too many ligand types 
...
class AutoDock4_1pgp_two_ligands_test( AutoDock_simple_test ):
    """Test that MSautodock4 can run dpf specifying two ligands."""
    dpf_stem = "1pgp_two_ligands"
    expected_outcome = True # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_two_mapsets_test( AutoDock_simple_test ):
    """Test that MSautodock4 can run dpf specifying two sets of maps and one ligand."""
...
class AutoDock4_1pgp_unbound_model_illegal_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops early if it finds an illegal unbound_model 
    in dpf """
...
class AutoDock4_1pgp_rmsmode_heavy_atoms_only_noH_test( AutoDock_simple_test ):
    """Test that MSautodock4 works if noHs when using new keyword rmsmode heavy_atoms_only."""
...
class AutoDock4_1pgp_rmsmode_all_heavy_atom_pairs_only_test( AutoDock_simple_test ):
    """Test that MSautodock4 works if rms calc uses all pairs of heavy_atoms.
...
class AutoDock4_1pgp_rmsmode_unique_heavy_atom_pairs_only_test( AutoDock_simple_test ):
    """Test that MSautodock4 works if rms calc uses only unique pairs of heavy_atoms specified 
...
class AutoDock4_1pgp_test( AutoDock_test ):
    """Test that MSautodock4 executes using an extremely short run."""
    dpf_stem = "1pgp"
    expected_outcome = True # True means Successful Completion!
#______________________________________________________________________________
...
class AutoDock4_1pgp_intelec_off_test( AutoDock_test ):
    """Test MSautodock4.3 internal energy off option yields 4.2 value."""
...
class AutoDock4_1pgp_timepid_test( AutoDock_simple_test ):
    """Test that MSautodock4 executes using seed set by time and process-id"""
    dpf_stem = "1pgp_timepid"
    expected_outcome = True # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_seed01_test( AutoDock_simple_test ):
    """Test that MSautodock4 stops using seeds  set to 0 1"""
    dpf_stem = "1pgp_seed01"
    expected_outcome = False # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_seed37_test( AutoDock_simple_test ):
    """Test that MSautodock4 executes using seeds  set to 3 7"""
    dpf_stem = "1pgp_seed37"
    expected_outcome = True # True means Successful Completion!
#______________________________________________________________________________

class AutoDock4_1pgp_seedinttime_test( AutoDock_simple_test ):
    """Test that MSautodock4 executes using seeds  set to integer and time"""
...
class AutoDock4_1pgp_gals_set_sw1_test( AutoDock_simple_test ):
    """Test that MSautodock4 gals_run succeeds with older sw1 rather than psw1."""
...
class AutoDock4_1pgp_smaller_test( AutoDock_simple_test ):
    ...
    """Test that MSautodock4 executes using fewer parameters and an extremely short run."""
...
class AutoDock4_1pgp_gals_use_defaults_test( AutoDock_test ):
    """Test that MSautodock4 executes using default gals parameters."""
