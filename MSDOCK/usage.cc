/* MSDOCK version 0.4 
 ...
 Added some version information and general usage for MSDOCK
...
/*----------------------------------------------------------------------------*/
{
    ...
    "\t\t\t--version (Print msdock version)\n" \
    "\t\t\t--help (Display this message)\n" \
    "\n" \
    "\tThe new method added in MSDOCK now only support command-line usage!\n" \
    ...
    "\tSet run_mode in .dpf file to \"msdock_run\" to start docking with MSLRDPSO\n" \
    "\tGeneral usage for MSDOCK:\n" \
