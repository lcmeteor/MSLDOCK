...
class Global_Search
{
   public:
      ...
      virtual int hysearch(Population &, Local_Search *, int, Eval *, int, FILE *) = 0; //MSDOCK
...
//   friend void debug(Genetic_Algorithm &, Population &);
   ...
   public:
      ...
      int hysearch(Population &, Local_Search *, int thNum, Eval *, int outlev, FILE * logFile) { return 0; } //MSDOCK
