...
////////////////////////////////////////////////////////////////////////////////
 ...
 ////////////////////////////////////////////////////////////////////////////////
	...
	if (thNum > 7 + sInit.ntor) thNum = 7 + sInit.ntor;
	//if (thNum > floor((7 + sInit.ntor)/2)) thNum = floor((7 + sInit.ntor)/2);
	if (thNum < 2) thNum = 2;
#else
	//thNum = floor(sqrt(7 + sInit.ntor));
	//if (thNum < 2)
		thNum = 2;
#endif
	pr(logFile, "Number of multi swarms of MSPSO = %d \n", thNum);
		 ...
		 j+1, nruns, GlobalSearchMethod->shortname() );
	        ...
	        printdate(logFile, 2 );
	 		...
	 		//Start Particle Swarm Optimization Run	               	 		
                sHist[nconf+j] = call_mspso( GlobalSearchMethod, LocalSearchMethod,
                                          sInit, thNum,
                                          num_evals, pop_size,
                                          outlev, logFile,
                                          output_pop_stats, &ligand, &evaluate,
