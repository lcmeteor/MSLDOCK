/* MSLDOCK version 0.4 
 ...
 Add some parameter settings for MSLDOCK
    ...
    const struct {
       ...
       const int tokenvalue;
	      ...
	      {"scale_eintermol", DPF_SCALE_EINTERMOL},
              ...
              , {"msrd_num_subs", MSRD_NSUBS} //MSLDOCK
              , {"msrd_FE_interval", MSRD_FEI}
              , {"alpha_start", ALPHA_START} 
              , {"alpha_end", ALPHA_END}
              , {"beta_start", BETA_START}
              , {"beta_end", BETA_END}
              , {"msrd_tvmax", MSRD_TVMAX} 
              , {"msrd_qvmax", MSRD_QVMAX}
              , {"msrd_rvmax", MSRD_RVMAX}
              , {"msrd_regenerate_at_limit", MSRD_REGENERATE_AT_LIMIT}
              , {"msldock_run", DPF_MSLDOCK} //MSLDOCK
