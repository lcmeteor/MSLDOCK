/* MSLDOCK version 0.4 
 ...
 Add a declaration of the call_mslrdpso function used in call_glss.cc
...
//MSLDOCK
State call_mslrdpso(Global_Search *const global_method, Local_Search *const local_method,
                const State& now, const int thNum, const unsigned int num_evals, const unsigned int pop_size,
                const int outlev, FILE *logFile, const Output_pop_stats& extOutput_pop_stats, Molecule *const mol,
                Eval *const evaluate,
                const Boole B_RandomTran0, const Boole B_RandomQuat0, const Boole B_RandomDihe0,
        const GridMapSetInfo *const info, const char *const FN_pop_file,
